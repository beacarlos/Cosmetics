//
//  DescriptionCosmeticsViewController.swift
//  Cosmebem
//
...
class DescriptionCosmeticsViewController: UIViewController {
    var tag: String = ""
    var findCategorie: String = ""
    var descriptionProductType: String = ""
    
    lazy var collectionView: UICollectionView = {
        let collectionView = UICollectionView(frame: .zero, collectionViewLayout: collectionViewLayout())
        collectionView.register(DescriptionCosmeticsCollectionViewCell.self, forCellWithReuseIdentifier: "DescriptionCosmeticsCollectionViewCell")
    ...
    lazy var descriptionView: DescriptionTagsView = {
        ...
        view.textDescription.text = descriptionProductType
        return view
    }()
    ...
    func callAPI() {
        Service.shared.findProductByType(productType: findCategorie) { (produtByTag) in
    ...
    override func viewDidLoad() {
        ...
        setupNavigationController(title: tag)
...
extension DescriptionCosmeticsViewController: UICollectionViewDelegate, UICollectionViewDataSource {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return result.count
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        guard let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "DescriptionCosmeticsCollectionViewCell", for: indexPath) as? DescriptionCosmeticsCollectionViewCell else { return DescriptionCosmeticsCollectionViewCell() }
